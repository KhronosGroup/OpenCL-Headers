...
typedef cl_uint     cl_bool; /* WARNING!  Unlike cl_ types in cl_platform.h, cl_bool is not
...
#pragma clang diagnostic ignored "-Wc11-extensions" /* Prevents warning about nameless union being \
                                                       C11 extension*/
#endif
#if defined(_MSC_VER) && defined(__STDC__)
