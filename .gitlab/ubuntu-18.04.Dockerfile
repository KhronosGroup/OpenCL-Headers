...
RUN mkdir -p /opt/Kitware/CMake ; \
    ...
    wget -c https://github.com/Kitware/CMake/releases/download/v3.3.2/cmake-3.3.2-Linux-x86_64.tar.gz -O - | tar -xz --directory /opt/Kitware/CMake ; \
    mv /opt/Kitware/CMake/cmake-3.3.2-Linux-x86_64 /opt/Kitware/CMake/3.3.2 ; \
